...
import cv2
import numpy as np
# --- NEW: Import settings to get default FPS ---
...
# --- MODIFIED: Use settings.CAMERA_FPS as the default rate ---
def mjpeg_generator(camera_id: int, fps: int = settings.CAMERA_FPS):
    boundary = b'--frame'
    # Calculate streaming interval based on the configured FPS
